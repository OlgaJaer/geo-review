...
/***/ "./src/common/getPlacemarks.js":
/*!*************************************!*\
  !*** ./src/common/getPlacemarks.js ***!
  \*************************************/
/*! exports provided: getPlacemarks */
...
/* harmony import */ var _events_getMap_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../events/getMap.js */ "./src/events/getMap.js");
/* harmony import */ var _events_addPlacemark_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../events/addPlacemark.js */ "./src/events/addPlacemark.js");
...
function getPlacemarks() {
  ...
  try {
    for (var _iterator = _index_js__WEBPACK_IMPORTED_MODULE_0__["myStorage"].items[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      try {
        for (var _iterator2 = item.reviews[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          _index_js__WEBPACK_IMPORTED_MODULE_0__["placemarksCoords"].items.push(item.coords);
          var placemark = Object(_events_addPlacemark_js__WEBPACK_IMPORTED_MODULE_2__["addPlacemark"])(item, review);

          if (placemark) {
            _events_getMap_js__WEBPACK_IMPORTED_MODULE_1__["clusterer"].add(placemark);
          }
        }
      } catch (err) {
...
/***/ "./src/common/getPoint.js":
/*!********************************!*\
  !*** ./src/common/getPoint.js ***!
  \********************************/
/*! exports provided: getPoint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPoint", function() { return getPoint; });
/* harmony import */ var _makePosition_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./makePosition.js */ "./src/common/makePosition.js");
...
function getPoint(e) {
  ...
  return myGeocoder.then(function (res) {
    ...
    var point = {
      address: "".concat(obj.properties.get('text')),
      coords: coords,
      position: Object(_makePosition_js__WEBPACK_IMPORTED_MODULE_0__["makePosition"])(position)
    };
    return point;
  });
}
...
/***/ "./src/common/makePosition.js":
/*!************************************!*\
  !*** ./src/common/makePosition.js ***!
  \************************************/
/*! exports provided: makePosition */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makePosition", function() { return makePosition; });
...
/***/ "./src/common/makeReview.js":
/*!**********************************!*\
  !*** ./src/common/makeReview.js ***!
  \**********************************/
/*! exports provided: makeReview */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeReview", function() { return makeReview; });
/* harmony import */ var _templates_makeFormTemplate_hbs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../templates/makeFormTemplate.hbs */ "./src/templates/makeFormTemplate.hbs");
/* harmony import */ var _templates_makeFormTemplate_hbs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_templates_makeFormTemplate_hbs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../index.js */ "./src/index.js");
/* harmony import */ var _events_getMap_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../events/getMap.js */ "./src/events/getMap.js");
/* harmony import */ var _events_addPlacemark_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../events/addPlacemark.js */ "./src/events/addPlacemark.js");




function makeReview(point) {
  var name = document.querySelector('#name');
  var place = document.querySelector('#place');
  var textReview = document.querySelector('#textReview');
  var reviewBlock = document.querySelector('#review-block');
  var newReview = {
    name: name.value,
    place: place.value,
  ...
  if (name.value && place.value && textReview.value) {
    ...
    if (_index_js__WEBPACK_IMPORTED_MODULE_1__["myStorage"].items.length) {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = _index_js__WEBPACK_IMPORTED_MODULE_1__["myStorage"].items[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var item = _step.value;
    ...
    if (flag === false) {
      ...
      _index_js__WEBPACK_IMPORTED_MODULE_1__["myStorage"].items.push(point);
    }
  } else {
    alert('Заполните все поля, чтобы добавить отзыв');
  }

  var htmlReview = _templates_makeFormTemplate_hbs__WEBPACK_IMPORTED_MODULE_0___default()(point);
  reviewBlock.innerHTML = htmlReview;
  _index_js__WEBPACK_IMPORTED_MODULE_1__["placemarksCoords"].items.push(point.coords);
  var placemark = Object(_events_addPlacemark_js__WEBPACK_IMPORTED_MODULE_3__["addPlacemark"])(point, newReview);

  if (placemark) {
    _events_getMap_js__WEBPACK_IMPORTED_MODULE_2__["clusterer"].add(placemark);
  }

  localStorage.data = JSON.stringify({
    items: _index_js__WEBPACK_IMPORTED_MODULE_1__["myStorage"].items
  });
}

/***/ }),

/***/ "./src/common/showForm.js":
/*!********************************!*\
  !*** ./src/common/showForm.js ***!
  \********************************/
...
/* harmony import */ var _templates_makeFormTemplate_hbs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../templates/makeFormTemplate.hbs */ "./src/templates/makeFormTemplate.hbs");
/* harmony import */ var _templates_makeFormTemplate_hbs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_templates_makeFormTemplate_hbs__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../index.js */ "./src/index.js");



function showForm(point) {
  var reviewBlock = document.querySelector('#review-block');
  ...
  try {
    for (var _iterator = _index_js__WEBPACK_IMPORTED_MODULE_2__["myStorage"].items[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var item = _step.value;
  ...
  var htmlReview = _templates_makeFormTemplate_hbs__WEBPACK_IMPORTED_MODULE_1___default()(point);
  reviewBlock.innerHTML = htmlReview;
  return point;
}
...
/***/ "./src/events/addPlacemark.js":
/*!************************************!*\
  !*** ./src/events/addPlacemark.js ***!
  \************************************/
/*! exports provided: addPlacemark */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index.js */ "./src/index.js");
/* harmony import */ var _common_showForm_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/showForm.js */ "./src/common/showForm.js");


function addPlacemark(point, newReview) {
  if (_index_js__WEBPACK_IMPORTED_MODULE_0__["placemarksCoords"].items.length) {
    var placemark = new ymaps.Placemark(_index_js__WEBPACK_IMPORTED_MODULE_0__["placemarksCoords"].items[_index_js__WEBPACK_IMPORTED_MODULE_0__["placemarksCoords"].items.length - 1], {
    ...
    placemark.events.add('click', function () {
      point = Object(_common_showForm_js__WEBPACK_IMPORTED_MODULE_1__["showForm"])(point);
    });
    return placemark;
  }
...
/***/ "./src/events/addReview.js":
/*!*********************************!*\
  !*** ./src/events/addReview.js ***!
  \*********************************/
/*! exports provided: addReview */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addReview", function() { return addReview; });
/* harmony import */ var _common_makeReview_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/makeReview.js */ "./src/common/makeReview.js");
...
function addReview() {
  document.addEventListener('click', function (e) {
    ...
    if (target.classList.contains('form__btn')) {
      ...
      Object(_common_makeReview_js__WEBPACK_IMPORTED_MODULE_0__["makeReview"])(point);
    }
  });
}
...
/***/ "./src/events/clickBalloonLink.js":
/*!****************************************!*\
  !*** ./src/events/clickBalloonLink.js ***!
  \****************************************/
/*! exports provided: clickBalloonLink */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clickBalloonLink", function() { return clickBalloonLink; });
/* harmony import */ var _common_showForm_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/showForm.js */ "./src/common/showForm.js");
/* harmony import */ var _common_makePosition_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/makePosition.js */ "./src/common/makePosition.js");


function clickBalloonLink() {
  document.addEventListener('click', function (e) {
    var target = e.target;

    if (target.classList.contains('balloon__link')) {
      e.preventDefault();
      var coords = target.dataset.coord.split(',');
      var myGeocoder = ymaps.geocode(coords);
      myGeocoder.then(function (res) {
        var position = [e.clientX - 100, e.clientY + 100];
        var obj = res.geoObjects.get(0);
        var point = {
          address: "".concat(obj.properties.get('text')),
          coords: coords,
          position: Object(_common_makePosition_js__WEBPACK_IMPORTED_MODULE_1__["makePosition"])(position)
        };
        return point;
      }).then(function (point) {
        Object(_common_showForm_js__WEBPACK_IMPORTED_MODULE_0__["showForm"])(point);
      });
    }
  });
}
...
/***/ "./src/events/getMap.js":
/*!******************************!*\
  !*** ./src/events/getMap.js ***!
  \******************************/
/*! exports provided: clusterer, getMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _common_getPoint__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../common/getPoint */ "./src/common/getPoint.js");
/* harmony import */ var _common_showForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common/showForm */ "./src/common/showForm.js");
/* harmony import */ var _common_getPlacemarks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../common/getPlacemarks */ "./src/common/getPlacemarks.js");
...
function getMap() {
  ...
  function init() {
    ...
    var customItemContentLayout = ymaps.templateLayoutFactory.createClass('<div class=balloon__content><h2 class=ballon__header>{{ properties.balloonContentHeader|raw }}</h2>' + '<a href="#" class=balloon__link data-coord="{{ properties.balloonContentCoords|raw }}">{{ properties.balloonContentLink|raw }}</a>' + '<div class=balloon__body>{{ properties.balloonContentBody|raw }}</div>' + '<div class=balloon__footer>{{ properties.balloonContentFooter|raw }}</div></div>');
    ...
    if (_index_js__WEBPACK_IMPORTED_MODULE_5__["myStorage"].items.length) {
      Object(_common_getPlacemarks__WEBPACK_IMPORTED_MODULE_4__["getPlacemarks"])();
    }
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(_common_getPoint__WEBPACK_IMPORTED_MODULE_2__["getPoint"])(e);

              case 2:
                point = _context.sent;
                _context.next = 5;
                return Object(_common_showForm__WEBPACK_IMPORTED_MODULE_3__["showForm"])(point);
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: myStorage, placemarksCoords */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _events_getMap_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./events/getMap.js */ "./src/events/getMap.js");
/* harmony import */ var _events_closeForm_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./events/closeForm.js */ "./src/events/closeForm.js");
/* harmony import */ var _events_addReview_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./events/addReview.js */ "./src/events/addReview.js");
/* harmony import */ var _events_clickBalloonLink_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./events/clickBalloonLink.js */ "./src/events/clickBalloonLink.js");
...
Object(_events_getMap_js__WEBPACK_IMPORTED_MODULE_2__["getMap"])();
Object(_events_closeForm_js__WEBPACK_IMPORTED_MODULE_3__["closeForm"])();
Object(_events_addReview_js__WEBPACK_IMPORTED_MODULE_4__["addReview"])();
Object(_events_clickBalloonLink_js__WEBPACK_IMPORTED_MODULE_5__["clickBalloonLink"])();
...
/***/ "./src/templates/makeFormTemplate.hbs":
/*!********************************************!*\
  !*** ./src/templates/makeFormTemplate.hbs ***!
  \********************************************/
/*! no static exports found */
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "            <li class=\"review__item\">\n                <div class=\"review__title\">\n                    <div class=\"review__name\">"
    ...
    + alias4(((helper = (helper = helpers.textReview || (depth0 != null ? depth0.textReview : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"textReview","hash":{},"data":data}) : helper)))
    + "</div>\n            </li>\n";
},"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return "<div class=\"review\">\n    <div class=\"header\" id=\"header\">\n        <div class=\"title\">\n            <img class=\"title__pic\" src=\"\"/>\n            <div class=\"title__text\">"
    + container.escapeExpression(((helper = (helper = helpers.address || (depth0 != null ? depth0.address : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"address","hash":{},"data":data}) : helper)))
    + "</div>        \n        </div>\n        <div class=\"header__close\" id=\"closeForm\"></div>\n    </div>\n    <div class=\"review__content\">\n        <ul class=\"review__list\" id=\"reviewList\">\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.reviews : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "        </ul>\n    </div>\n    <form class=\"form\" name=\"form\" action=\"\">\n        <div class=\"form__title\">ваш отзыв</div>\n        <input type=\"text\" name=\"form\"  id=\"name\" class=\"form__input form__input--name\" placeholder=\"Ваше имя\">\n        <input type=\"text\" name=\"form\" id=\"place\" class=\"form__input form__input--place\" placeholder=\"Укажите место\">\n        <textarea  id=\"textReview\" name=\"form\"  class=\"form__input form__input--review\" placeholder=\"Поделитесь впечатлениями\"></textarea>\n        <button type=\"submith\" class=\"form__btn\" id=\"save\">Добавить</button>\n    </form>\n</div>";
},"useData":true});

/***/ })

/******/ });
//# sourceMappingURL=index.a7122cbdfba0da6f8a2c.js.map